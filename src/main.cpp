...
int main(int argc, char *argv[])
{
    ...
    if (strcmp(argv[1], "1") == 0) {
        freopen("../results/benchmark_data_stream.txt","w",stdout);
        ...
        freopen("../results/benchmark_buffered_stream.txt","w",stdout);
        ...
        freopen("../results/benchmark_buffered_stream_fixed_size.txt","w",stdout);
        ...
        freopen("../results/benchmark_memory_mapping.txt","w",stdout);
        ...
        freopen("../results/benchmark_external_merge_sort.txt","w",stdout);
